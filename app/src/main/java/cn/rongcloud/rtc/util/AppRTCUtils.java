  ...
  public static boolean setCMPAddress(String cmpServer,String serverURl,int type){
    ...
    try {
      ...
      if(TextUtils.isEmpty(cmpServer)){
        Toast.makeText(Utils.getContext(), R.string.serverCMPcannotbeempty, Toast.LENGTH_SHORT).show();
        return false;
      }

      if(TextUtils.isEmpty(serverURl)){
        Toast.makeText(Utils.getContext(), R.string.serverTOKENcannotbeempty, Toast.LENGTH_SHORT).show();
        return false;
      }

      if(!isURL(serverURl)){
        Toast.makeText(Utils.getContext(), R.string.tokenAddressisINcorrect, Toast.LENGTH_SHORT).show();
        return false;
      }
