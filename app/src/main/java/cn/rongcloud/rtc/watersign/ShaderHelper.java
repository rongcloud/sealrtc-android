...
public class ShaderHelper {
    ...
    private static int compileShader(int type,String shaderCode){
        ...
        Log.d(TAG, "compileShader: status="+status[0]+", info="+GLES20.glGetShaderInfoLog(shaderObjId));
    ...
    public static int linkProgram(int vertexShaderId,int fragmentShaderId){
        ...
        Log.d(TAG, "linkProgram: status="+status[0]+" results of linking program:"+GLES20.glGetProgramInfoLog(programObjectId));
    ...
    public static boolean validateProgram(int programObjectId){
        ...
        Log.d(TAG, "validateProgram: status="+validateStatus[0]+", log="+GLES20.glGetProgramInfoLog(programObjectId));
