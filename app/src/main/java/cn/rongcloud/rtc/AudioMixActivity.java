...
public class AudioMixActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (REQUEST_OPEN_FILE == requestCode && resultCode == Activity.RESULT_OK) {
          if (data != null) {
            ...
            if (file == null) {
              Toast.makeText(this, "获取不到该文件的绝对路径！", Toast.LENGTH_LONG).show();
              return;
            }
    ...
    if (ContentResolver.SCHEME_FILE.equals(scheme)) {
      ...
      if ("com.android.externalstorage.documents".equals(authority)) {
        ...
        if ("primary".equalsIgnoreCase(type)) {
          ...
          StorageManager mStorageManager = (StorageManager) getSystemService(
