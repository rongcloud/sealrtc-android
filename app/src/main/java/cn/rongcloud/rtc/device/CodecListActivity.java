...
public class CodecListActivity extends DeviceBaseActivity {
    ...
    private void initData() {
        ...
        codecMediaTypeAdapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onClick(int position) {
                if(TextUtils.isEmpty(CodecType)){
                    Toast.makeText(CodecListActivity.this, "编码器类型错误", Toast.LENGTH_SHORT).show();
                    return;
                }
                mediaTypes.clear();
                String name ="";
                ...
                if (!TextUtils.isEmpty(name)) {
                    Intent intent = new Intent(CodecListActivity.this, CodecColorFormatActivity.class);
