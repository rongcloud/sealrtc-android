...
public class SelectionParametersActivity extends DeviceBaseActivity {
    ...
    private void post(String content) {
        ...
        //                SessionManager.getInstance().put(Consts.SP_ENCODER_TYPE_KEY,
        // content.equals(getResources().getString(R.string.hw_encoder_str)) ? true : false);
        //                break;
        ...
        //                SessionManager.getInstance().put(Consts.SP_DECODER_TYPE_KEY,
        // content.equals(getResources().getString(R.string.hw_decoder_str)) ? true : false);
        //                break;
        //            case Consts.REQUEST_CODE_DECODER_NAME:
        //                SessionManager.getInstance().put(Consts.SP_ENCODER_NAME_KEY, content);
        //                break;
        //            case REQUEST_CODE_CAPTURE_TYPE:
        //                SessionManager.getInstance().put(ACQUISITION_MODE_KEY,
        // content.equals(getResources().getString(R.string.capture_type_texture)) ? true : false);
        //                break;
        //            case REQUEST_CODE_ENCODER_LEVEL:
        //                SessionManager.getInstance().put(Consts.SP_ENCODER_LEVEL_KEY,
        // content.equals(getResources().getString(R.string.encoder_leval_hight)) ? true : false);
        //                break;
        //            default:
        //                break;
        //        }
