...
public class Consts {
    public static final String SP_ENCODER_COLOR_FORMAT_ALIAS_KEY= "SP_ENCODER_COLOR_FORMAT_ALIAS_KEY";//存储编码颜色空间别名
    public static final String SP_DECODER_COLOR_FORMAT_ALIAS_KEY= "DECODER_COLORFORMATKEY";//string
    public static final String SP_DECODER_COLOR_FORMAT_VAL_KEY= "DECODER_COLORFORMAT_VAL_KEY";//int
    public static final String SP_ENCODER_COLOR_FORMAT_VAL_KEY= "ENCODER_COLORFORMAT_VAL_KEY";//int
    ...
    public static final String CAPTURE_CAMERA_DISPLAY_ORIENTATION_KEY = "CAPTURE_CAMERADISPLAYORIENTATION_KEY";
    public static final String CAPTURE_FRAME_ORIENTATION_KEY = "CAPTURE_FRAMEORIENTATION_KEY";

    public static final String SP_AUDIO_SAMPLE_USE_AUDIO_RECORDER ="SP_AUDIO_SAMPLE_USE_AUDIO_RECORDER";
    ...
    public static final String SP_AUDIO_NOISE_SUPPRESSION_LEVEL = "SP_AUDIO_NOISE_SUPPRESSION_LEVEL";
    ...
    public static final String SP_AUDIO_ECHO_CANCEL_FILTER_ENABLE = "SP_AUDIO_ECHO_CANCEL_FILTER_ENABLE";
    ...
    public static final String EXTRA_KEY_REQUEST_ARRAYLIST_DATA = "EXTRA_KEY_REQUEST_ARRAYLIST_DATA";
}
