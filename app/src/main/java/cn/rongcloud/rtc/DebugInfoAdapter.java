...
public class DebugInfoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.userIdView = (TextView) convertView.findViewById(R.id.debug_info_uid);
            holder.mediaTypeView = (TextView) convertView.findViewById(R.id.debug_info_media_type);
            holder.codecView = (TextView) convertView.findViewById(R.id.debug_info_codec);
            holder.resolutionView = (TextView) convertView.findViewById(R.id.debug_info_resolution);
            holder.fpsView = (TextView) convertView.findViewById(R.id.debug_info_fps);
            holder.bitrateView = (TextView) convertView.findViewById(R.id.debug_info_bitrate);
            holder.lostRateView = (TextView) convertView.findViewById(R.id.debug_info_lost_rate);
