...
public class CheckGroup extends LinearLayout {
     ...
     * View.NO_ID as the selection identifier clears the selection; such an operation is equivalent
     * to invoking {@link #clearCheck()}.
     *
     ...
     * selected and {@link #getCheckedCheckBoxId()} returns null.
     *
     * @see #check(int)
     * @see #getCheckedCheckBoxId()
     */
