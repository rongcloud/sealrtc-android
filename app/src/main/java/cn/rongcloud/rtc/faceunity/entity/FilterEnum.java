...
public enum FilterEnum {
    ...
    //    lengsediao_5(Filter.Key.LENGSEDIAO_5, R.drawable.demo_icon_lengsediao5,
    // R.string.lengsediao_5),
    //    lengsediao_6(Filter.Key.LENGSEDIAO_6, R.drawable.demo_icon_lengsediao6,
    // R.string.lengsediao_6),
    ...
    //    lengsediao_9(Filter.Key.LENGSEDIAO_9, R.drawable.demo_icon_lengsediao9,
    // R.string.lengsediao_9),
    //    lengsediao_10(Filter.Key.LENGSEDIAO_10, R.drawable.demo_icon_lengsediao10,
    // R.string.lengsediao_10),
    lengsediao_11(
            Filter.Key.LENGSEDIAO_11, R.drawable.demo_icon_lengsediao11, R.string.lengsediao_11),
    ...
    //    nuansediao_3(Filter.Key.NUANSEDIAO_3, R.drawable.demo_icon_nuansediao3,
    // R.string.nuansediao_3),
    ...
    xiaoqingxin_1(
            Filter.Key.XIAOQINGXIN_1, R.drawable.demo_icon_xiaoqingxin1, R.string.xiaoqingxin_1),
    //    xiaoqingxin_2(Filter.Key.XIAOQINGXIN_2, R.drawable.demo_icon_xiaoqingxin2,
    // R.string.xiaoqingxin_2),
    xiaoqingxin_3(
            Filter.Key.XIAOQINGXIN_3, R.drawable.demo_icon_xiaoqingxin3, R.string.xiaoqingxin_3),
    xiaoqingxin_4(
            Filter.Key.XIAOQINGXIN_4, R.drawable.demo_icon_xiaoqingxin4, R.string.xiaoqingxin_4),
    //    xiaoqingxin_5(Filter.Key.XIAOQINGXIN_5, R.drawable.demo_icon_xiaoqingxin5,
    // R.string.xiaoqingxin_5),
    xiaoqingxin_6(
            Filter.Key.XIAOQINGXIN_6, R.drawable.demo_icon_xiaoqingxin6, R.string.xiaoqingxin_6),
