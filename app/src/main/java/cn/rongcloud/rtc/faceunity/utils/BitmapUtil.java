...
import cn.rongcloud.rtc.faceunity.gles.ProgramTexture2d;
import cn.rongcloud.rtc.faceunity.gles.ProgramTextureOES;
...
public class BitmapUtil {
    ...
    public static int getPhotoOrientation(String path) {
        ...
        try {
            tagOrientation =
                    new ExifInterface(path).getAttributeInt(ExifInterface.TAG_ORIENTATION, -1);
        } catch (IOException e) {
