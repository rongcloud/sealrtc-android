package cn.rongcloud.rtc.faceunity.ui.widget.beautybox;
 ...
 *
 * <p>Created by tujh on 2018/4/17.
 */
public class BeautyBox extends BaseBeautyBox {
    ...
    protected void obtainStyle(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a =
                context.obtainStyledAttributes(attrs, R.styleable.BeautyBox, defStyleAttr, 0);
        ...
        textNormalColor =
                a.getColor(
                        R.styleable.BeautyBox_textColor_normal,
                        getResources().getColor(R.color.main_color_c5c5c5));
        textCheckedColor =
                a.getColor(
                        R.styleable.BeautyBox_textColor_checked,
