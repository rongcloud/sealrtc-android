package cn.rongcloud.rtc.faceunity.ui.adapter;
...
public class EffectRecyclerAdapter
        extends RecyclerView.Adapter<EffectRecyclerAdapter.HomeRecyclerHolder> {
    ...
    public EffectRecyclerAdapter(
            Context context, int effectType, OnFUControlListener onFUControlListener) {
        mContext = context;
    ...
    public void onBindViewHolder(HomeRecyclerHolder holder, final int position) {
        ...
        holder.effectImg.setOnClickListener(
                new OnMultiClickListener() {
                    ...
                    protected void onMultiClick(View v) {
                        ...
                        if (mOnDescriptionChangeListener != null)
                            mOnDescriptionChangeListener.onDescriptionChangeListener(click);
                    }
                });
        if (mPositionSelect == position) {
    ...
    public void playMusic(Effect effect) {
        ...
        try {
            AssetFileDescriptor descriptor =
                    mContext.getAssets()
                            .openFd("effect/musicfilter/" + effect.bundleName() + ".mp3");
    ...
    public void setOnDescriptionChangeListener(
    ...
    public interface OnDescriptionChangeListener {
        void onDescriptionChangeListener(Effect click);
    }
}
