...
import cn.rongcloud.rtc.faceunity.utils.FileUtils;
...
public class LivePhoto implements Parcelable {
    ...
    public LivePhoto(
            ...
            int width,
            int height,
            String groupPointsStr,
            String groupTypeStr,
            String templateImagePath,
            String stickerImagePathStr,
    ...
    public boolean equals(Object o) {
        ...
        return templateImagePath != null
                ? templateImagePath.equals(that.templateImagePath)
                : that.templateImagePath == null;
    }
    ...
    public static final Creator<LivePhoto> CREATOR =
            new Creator<LivePhoto>() {
                @Override
