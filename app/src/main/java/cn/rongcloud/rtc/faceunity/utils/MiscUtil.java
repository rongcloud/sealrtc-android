package cn.rongcloud.rtc.faceunity.utils;

import static cn.rongcloud.rtc.faceunity.utils.Constant.filePath;
...
public class MiscUtil {
    ...
    private Bitmap processImage(int width, int height, byte[] data) throws IOException {
        ...
        // Bitmap cropped = Bitmap.createBitmap(bitmap, 0, 0, croppedWidth, croppedHeight, matrix,
        // true);
        // bitmap.recycle();
    ...
    public static String saveBitmapToFile(final Bitmap bitmap) {
        ...
        final String fileName =
                filePath + getCurrentDate() + "_" + System.currentTimeMillis() + IMAGE_FORMAT_JPG;
