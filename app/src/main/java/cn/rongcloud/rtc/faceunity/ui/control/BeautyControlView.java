package cn.rongcloud.rtc.faceunity.ui.control;

import static cn.rongcloud.rtc.faceunity.entity.BeautyParameterModel.DEFAULT_FILTER_LEVEL;
import static cn.rongcloud.rtc.faceunity.entity.BeautyParameterModel.STR_FILTER_LEVEL;
import static cn.rongcloud.rtc.faceunity.entity.BeautyParameterModel.getValue;
import static cn.rongcloud.rtc.faceunity.entity.BeautyParameterModel.isOpen;
import static cn.rongcloud.rtc.faceunity.entity.BeautyParameterModel.sFilter;
import static cn.rongcloud.rtc.faceunity.entity.BeautyParameterModel.sFilterLevel;
import static cn.rongcloud.rtc.faceunity.entity.BeautyParameterModel.setValue;
...
import cn.rongcloud.rtc.faceunity.entity.BeautyParameterModel;
import cn.rongcloud.rtc.faceunity.entity.Filter;
import cn.rongcloud.rtc.faceunity.entity.FilterEnum;
import cn.rongcloud.rtc.faceunity.ui.dialog.BaseDialogFragment;
import cn.rongcloud.rtc.faceunity.ui.dialog.ConfirmDialogFragment;
import cn.rongcloud.rtc.faceunity.ui.widget.CheckGroup;
import cn.rongcloud.rtc.faceunity.ui.widget.TouchStateImageView;
import cn.rongcloud.rtc.faceunity.ui.widget.beautybox.BaseBeautyBox;
import cn.rongcloud.rtc.faceunity.ui.widget.beautybox.BeautyBoxGroup;
import cn.rongcloud.rtc.faceunity.ui.widget.seekbar.DiscreteSeekBar;
import cn.rongcloud.rtc.util.OnMultiClickListener;
import java.util.List;

/** 美颜 Created by tujh on 2017/8/15. */
public class BeautyControlView extends FrameLayout
        implements TouchStateImageView.OnTouchStateListener {
    ...
    private void initView() {
        ...
        mBottomView.setOnTouchListener(
                new OnTouchListener() {
                    @Override
        ...
        initViewTop();
        mBottomCheckGroup.check(R.id.beauty_radio_skin_beauty);
    }
    ...
    private void initViewBottomRadio() {
        ...
        mBottomCheckGroup.setOnCheckedChangeListener(
                new CheckGroup.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CheckGroup group, int checkedId) {
                                ...
                                case R.id.beauty_radio_filter:
                                    {
                                        Float valueObj =
                                                sFilterLevel.get(
                                                        STR_FILTER_LEVEL + sFilter.filterName());
                                        if (valueObj == null) {
                        ...
                        //                if ((checkedId == View.NO_ID || checkedId == checkedIdOld)
                        // && checkedIdOld != View.NO_ID) {
                        //                    int endHeight = DecimalUtils.dip2px(getContext(),1);
                        //                    int startHeight =
                        // DecimalUtils.dip2px(getContext(),134);
                        //                    changeBottomLayoutAnimator(startHeight, endHeight);
                        //                    mIvCompare.setVisibility(INVISIBLE);
                        //                    isShown = false;
                        //                } else if (checkedId != View.NO_ID && checkedIdOld ==
                        // View.NO_ID) {
                        //                    int startHeight = DecimalUtils.dip2px(getContext(),1);
                        //                    int endHeight = DecimalUtils.dip2px(getContext(),134);
                        //                    changeBottomLayoutAnimator(startHeight, endHeight);
                        //                    isShown = true;
                        //                }
    ...
    private void initViewSkinBeauty() {
        ...
        mIvRecoverFaceSkin.setOnClickListener(
                new OnMultiClickListener() {
                    @Override
                    protected void onMultiClick(View v) {
                        ConfirmDialogFragment confirmDialogFragment =
                                ConfirmDialogFragment.newInstance(
                                        mContext.getString(R.string.dialog_reset_avatar_model),
                                        new BaseDialogFragment.OnClickListener() {
                                            ...
                                            public void onConfirm() {
                                                ...
                                                updateViewSkinBeauty();
                                                int checkedId =
                                                        mSkinBeautyBoxGroup.getCheckedBeautyBoxId();
        ...
        mSkinBeautyBoxGroup.setOnCheckedChangeListener(
                new BeautyBoxGroup.OnCheckedChangeListener() {
                    @Override
    ...
    private void initViewFaceShape() {
        ...
        mIvRecoverFaceShape.setOnClickListener(
                new OnMultiClickListener() {
                    @Override
                    protected void onMultiClick(View v) {
                        ConfirmDialogFragment confirmDialogFragment =
                                ConfirmDialogFragment.newInstance(
                                        ...
                                        new BaseDialogFragment.OnClickListener() {
                                            ...
                                            public void onConfirm() {
                                                ...
                                                updateViewFaceShape();
                                                seekToSeekBar(
                                                        mShapeBeautyBoxGroup
                                                                .getCheckedBeautyBoxId());
        ...
        mShapeBeautyBoxGroup.setOnCheckedChangeListener(
                new BeautyBoxGroup.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(BeautyBoxGroup group, int checkedId) {
    ...
    private void initViewTop() {
        ...
        mBeautySeekBar.setOnProgressChangeListener(
    ...
    private void seekToSeekBar(int checkedId) {
        ...
        int min = 0;
        int max = 100;
        if (checkedId == R.id.beauty_box_intensity_chin
                || checkedId == R.id.beauty_box_intensity_forehead
                || checkedId == R.id.beauty_box_intensity_mouth
                || checkedId == R.id.beauty_box_long_nose
                || checkedId == R.id.beauty_box_eye_space
                || checkedId == R.id.beauty_box_eye_rotate
    ...
    // mBottomView.getLayoutParams();
    //                params.height = height;
    //                mBottomView.setLayoutParams(params);
    //                if (mOnBottomAnimatorChangeListener != null) {
    //                    float showRate = 1.0f * (height - startHeight) / (endHeight -
    // startHeight);
    //                    mOnBottomAnimatorChangeListener.onBottomAnimatorChangeListener(startHeight
    // > endHeight ? 1 - showRate : showRate);
    //                }
    //                if (DecimalUtils.floatEquals(animation.getAnimatedFraction(), 1.0f) &&
    ...
    public void setOnBottomAnimatorChangeListener(
            OnBottomAnimatorChangeListener onBottomAnimatorChangeListener) {
                    ...
                    new OnMultiClickListener() {
                        ...
                        protected void onMultiClick(View v) {
                            ...
                            if (mOnFUControlListener != null) {
                                ...
                                mOnFUControlListener.onFilterNameSelected(sFilter.filterName());
                                //                       ToastUtil.showNormalToast(mContext,
                                // sFilter.getNameId());
                                Toast.makeText(mContext, sFilter.getNameId(), Toast.LENGTH_SHORT)
                                        .show();
                            }
                        }
                    });
